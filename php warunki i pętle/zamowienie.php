...
$kwota_butow_netto = $ile_buty*BUTY; // wartość netto zamówionych koszulek
...
$kwota_butow_brutto = $kwota_butow_netto + $kwota_butow_netto*P_VAT; // wartość butow koszulek
...
echo "Cena netto zamówionych butow: ".$kwota_butow_netto."<br/>";
...
echo "Cena brutto zamówionych butow: ".$kwota_butow_brutto."<br/>";
